...
import CallMeBlock from "../CallMeBlock";

const Header = () => {
  const [isActive, setIsActive] = useState(false);
//   const [isOpenCallMeBlock, setOpenCallMeBlock] = useState(false);
...
//   const openCallMeBlock = (event) => {
//     setOpenCallMeBlock((prev) => !prev);
//     document.documentElement.style.overflowY = !isOpenCallMeBlock
//       ? "hidden" && event.target.classlist.add("active")
//       : "auto" && event.target.classlist.remove("active");
//     document.body.style.overflowY = !isOpenCallMeBlock ? "hidden" : "auto";
//   };
  ...
  return (
    <header className={styles.header}>
      {/* <CallMeBlock onClick={openCallMeBlock} /> */}
